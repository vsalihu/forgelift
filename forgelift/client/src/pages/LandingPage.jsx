      ...
      <main className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-8">
        <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-forge-ember px-5 py-2 text-sm font-semibold text-white transition hover:bg-orange-600"
              to="/register"
            >
        ...
        >
          {[
            ...
            <div className="metal-panel rounded-lg p-5" key={item.title}>
              <item.icon className="mb-4 h-7 w-7 text-forge-ember" />
