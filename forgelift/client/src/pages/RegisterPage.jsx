    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto flex max-w-md flex-col justify-center px-4 py-12">
        <div className="metal-panel rounded-lg p-6 shadow-metal">
          ...
          <p className="mt-2 text-sm text-slate-400">Set up your ForgeLift profile foundation.</p>
          ...
          <p className="mt-5 text-center text-sm text-slate-400">
            ...
            <Link className="font-semibold text-forge-ember hover:text-orange-300" to="/login">
              Login
            </Link>
          </p>
        </div>
